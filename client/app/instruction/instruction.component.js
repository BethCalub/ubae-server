...
export class InstructionComponent {
  ...
  constructor($http, $scope, socket) {
    ...
    this.dataInfo = {
      name: 'Instruction',
      info: 'The instruction table contains the services offered by the University and its processes. This table consists data which answers HOW questions.',
      guide: ['The variable \'name\' contains the name of the service.',
      'The variable \'process\' contains the processes involved in the service.',
      'The \'message\' variable contains the sentence form of \'process\' which will serve as UBAEs reply. Try to make it witty as possible as to emulate more human-like thinking.',
  ...
  getEntry(_id) {
    ...
    .then(response => {
      ...
      this.details = response.data.process;
