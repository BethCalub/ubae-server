...
var information = [{
  ...
  tags: ['SBAA', 'Department', 'Accounting', 'Accountancy', 'Business', 'Administration', 'School']
}, {
  ...
  tags: ['SCJPS', 'Department', 'crim', 'police', 'Criminal', 'Justice', 'Public', 'Safety', 'School']
}, {
  ...
  tags: ['SEA', 'Department', 'Engineering', 'Engineer', 'Architecture', 'Arki', 'School']
}, {
  ...
  tags: ['SLAHS', 'Department', 'Liberal', 'Arts', 'Human', 'Sciences', 'School']
}, {
  ...
  tags: ['SNS', 'Department', 'SNS', 'Natural', 'Sciences', 'School']
}, {
  ...
  tags: ['SOD', 'Department', 'SOD', 'Dentist', 'Dentistry', 'School']
}, {
  name: 'School of Law',
  ...
  tags: ['SOL', 'Department', 'SOL', 'Law', 'Lawyer', 'School']
}, {
  ...
  tags: ['SON', 'Department', 'SON', 'Nursing', 'Nurse', 'School']
}, {
  ...
  tags: ['STE', 'Department', 'STE', 'Educ', 'Education', 'Teacher', 'School']
}, {
  ...
  tags: ['ARC', 'Admissions', 'Records', 'Center', 'Office']
}, {
  ...
  tags: ['CCSD', 'Counseling', 'Student', 'Development', 'Office']
}, {
  ...
  tags: ['ECOS', 'Community', 'Outreach', 'Services', 'Office']
}, {
  ...
  tags: ['LARC', 'Linkages', 'Review', 'Alumni', 'Office']
}, {
  name: 'UB Library',
  ...
  tags: ['Media', 'Publications', 'Office']
}, {
  ...
  tags: ['RNDC', 'Research', 'Devlopment', 'Office']
}, {
  ...
  tags: ['SAS', 'Student', 'Accounts', 'Office']
}, {
  ...
  info: 'A 2 Year Course, Masters Degree, for Graduate Students, offerred in SBAA department',
  type: '',
  message: 'Master in Business Administration (MBA) is a 2 year Masters Degree course for Graduate Students offerred in the SBAA department',
  tags: ['MBA', 'BA', 'MA', 'Master', 'Business', 'Administration', 'Program', 'SBAA']
}, {
  name: 'Bachelor of Science in Accountancy (BS-AC)',
  info: 'A 5 Year Course, Bachelors Degree, must take Licensure Examination for Certified Public Accountants after graduation, offerred in SBAA department',
  type: '',
  message: 'Bachelor of Science in Accountancy (BS-AC) is a 5 year Bachelors Degree course offerred in the SBAA department. After graduation Licensure Examination for Certified Public Accountants must be taken',
  tags: ['BS', 'AC', 'BSAC', 'Bachelor', 'Science', 'Accountancy', 'Course', 'Program', 'SBAA', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Business Administration, major in Financial Management (BSBA-FM)',
  info: 'A 4 Year Course, Bachelors Degree, offerred in SBAA department',
  type: '',
  message: 'Bachelor of Science in Business Administration, major in Financial Management (BSBA-FM) is a 4 year Bachelors Degree course offerred in the SBAA department',
  tags: ['BS', 'BAFM', 'BSBAFM', 'FinMan', 'Bachelor', 'Science', 'Financial', 'Management', 'Program', 'Course', 'SBAA', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Business Administration, major in Marketing Management (BSBA-MM)',
  info: '4 Year Course, Bachelors Degree, offerred in SBAA department',
  type: '',
  message: 'Bachelor of Science in Business Administration, major in Marketing Management (BSBA-MM) is a 4 year Bachelors Degree course offerred in the SBAA department',
  tags: ['BS', 'BAMM', 'BSBAMM', 'Bachelor', 'Science', 'Marketing', 'Management', 'Program', 'Course', 'SBAA', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Business Administration, major in Operations Management (BSBA-OM)',
  info: '4 Year Course, Bachelors Degree, offerred in SBAA department',
  type: '',
  message: 'Bachelor of Science in Business Administration, major in Operations Management (BSBA-OM) is a 4 year Bachelors Degree course offerred in the SBAA department',
  tags: ['BS', 'BAOM', 'BSBAOM', 'Bachelor', 'Science', 'Operations', 'Management', 'Program', 'Course', 'SBAA', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Business Administration, major in Human Resource Development Management (BSBA-HRDM)',
  info: '4 Year Course, Bachelors Degree, offerred in SBAA department',
  type: 'Baccaluarate',
  message: 'Bachelor of Science in Business Administration, major in Human Resource Development Management (BSBA-HRDM) is a 4 year Bachelors Degree course offerred in the SBAA department',
  tags: ['BS', 'BAHRDM', 'BSBAHRDM', 'Bachelor', 'Science', 'Human', 'Resource', 'Development', 'Management', 'Program', 'Course', 'SBAA', 'Baccalaureate']
}, {
  name: 'Associate in Accounting Technology (AAT)',
  info: '3 Year Ladderized Program, offerred in SBAA department',
  type: '',
  message: 'Associate in Accounting Technology is a 3 Year Ladderized Program in the SBAA department',
  tags: ['AAT', 'Associate', 'Accounting', 'Technology', 'Program', 'Course', 'SBAA']
}, {
  name: 'Certificate in Accounting Technology (CAT)',
  info: '2 Year Ladderized Program, offerred in SBAA department',
  type: '',
  message: 'Certificate in Accounting Technology (CAT) is a 2 Year Ladderized Program in the SBAA department',
  tags: ['CAT', 'Certificate', 'Accounting', 'Technology', 'Program', 'Course', 'SBAA']
}, {
  name: 'Doctor of Philosophy in Criminal Justice with Specialization in Criminology (PHD-CJSC)',
  info: '3 Year course, must be a Graduate of BS-CRIM or BFSci, Doctorate Degree, offerred in SCJPS department',
  type: '',
  message: 'Doctor of Philosophy in Criminal Justice with Specialization in Criminology (PHD-CJSC) is a 3 year course for BS-Crim or BFSci graduate offerred in the SCJPS department',
  tags: ['PHD', 'CJSC', 'PHDCJSC', 'Doctor', 'Philosophy', 'Criminal', 'Justice', 'Specialization', 'Criminology', 'Program', 'Course', 'SCJPS']
}, {
  name: 'Master of Science in Criminal Justice with Specialization in Criminology (MS-CJSC)',
  info: '2 Years course, must be a Graduate of BS-CRIM or BFSci, Masters Degree, offerred in the SCJPS department',
  type: '',
  message: 'Master of Science in Criminal Justice with Specialization in Criminology (MS-CJSC) is a 2 year course for BS-CRIM or BFSci graduates offerred in the SCJPS department',
  tags: ['MA', 'SCJSC', 'MSCJSC', 'Master', 'Science', 'Criminal', 'Justice', 'Specialization', 'Criminology', 'Program', 'Course', 'SCJPS']
}, {
  name: 'Bachelor of Science in Criminology (BS-CRIM)',
  info: '4 year course, must take Licensure Examination for Criminologists after graduation, Bachelors Degree, offerred in SCJPS department',
  type: '',
  message: 'Bachelor of Science in Criminology (BS-CRIM) is a 4 year Bachelors Degree course offerred in the SCJPS department. After graduation Licensure Examination for Criminologists must be taken. ',
  tags: ['BS', 'BSCRIM', 'crim', 'Bachelor', 'Science', 'Criminology', 'Program', 'Course', 'SCJPS', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Forensic Science (BFSci)',
  info: '4 Year course, Bachelors Degree, offerred in SCJPS department',
  type: '',
  message: 'Bachelor of Science in Forensic Science (BFSci) is a 4 year Bachelors Degree course offerred in the SCJPS Department',
  tags: ['BFSci', 'BS', 'FSCI', 'Bachelor', 'Science', 'Forensic', 'Program', 'Course', 'SCJPS', 'Baccalaureate']
}, {
  name: 'Master in Dental Education (MDE)',
  info: '2 Years course, must be a Graduate of Doctor of Dental Medicine, Masters Degree, offerred in SOD department',
  type: '',
  message: 'Master in Dental Education (MDE) is a 2 year Masters Degree course for Graduates of Doctor of Dental Medicine',
  tags: ['MA', 'DE', 'MDE', 'Master', 'Dental', 'Education', 'Program', 'Course', 'SOD', 'Baccalaureate']
}, {
  ...
  type: '',
  message: 'Doctor of Dental Medicine (DM) is a 4 year Bachelors Degree course for graduates of Pre-Dentistry offerred in the SOD department',
  tags: ['DM', 'Doctor', 'Dental', 'Medicine', 'Program', 'Course', 'SOD', 'Baccalaureate']
}, {
  name: 'Pre-Dentistry',
  info: '2 Year course, Short Course, offerred in SOD department',
  type: '',
  message: 'Pre-Dentistry is a 2 Year Short Course offerred in the SOD department',
  tags: ['Pre', 'Den', 'Dentistry', 'Program', 'Course', 'SOD']
}, {
  name: 'Bachelor of Science in Architecture (BS-ARCH)',
  info: '5 Year course, must take Licensure Examination for Architects after graduation, Bachelors Degree, offerred in SEA department',
  type: '',
  message: 'Bachelor of Science in Architecture (BS-ARCH) is a 5 Year Bachelors Degree course offerred in the SEA department. After graduation Licensure Examination for Architects must be taken',
  tags: ['BSARCH', 'BS', 'ARCH', 'Bachelor', 'Science', 'Architecture', 'Program', 'Course', 'SEA', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Civil Engineering (BS-CE)',
  info: '5 Year course, must take Licensure Examination for Civil Engineers after graduation, Bachelors Degree, offerred in SEA department',
  type: '',
  message: 'Bachelor of Science in Civil Engineering (BS-CE) is a 5 year Bachelors Degree course offerred in the SEA department. After graduation Licensure Examination for Civil Engineers must be taken',
  tags: ['BSCE', 'BS', 'CE', 'Bachelor', 'Science', 'Civil', 'Engineering', 'Program', 'Course', 'SEA', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Electronics and Communications Engineering (BS-ECE)',
  info: '5 Year course, must take Licensure Examination for Electronics and Communications Engineers after graduation, Bachelors Degree, offerred in SEA department',
  type: '',
  message: 'Bachelor of Science in Electronics and Communications Engineering (BS-ECE) is a 5 year Bachelors Degree course offerred in the SEA department. After graduation Licensure Examination for Electronics and Communications must be taken',
  tags: ['BSECE', 'BS', 'ECE', 'Bachelor', 'Science', 'Electronics', 'Communications', 'Engineering', 'Program', 'Course', 'SEA', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Environmental and Sanitary Engineering (BS-ESE)',
  info: '5 Year course, must take Licensure Examination for Sanitary Engineers after graduation, Bachelors Degree, offerred in SEA department',
  type: '',
  message: 'Bachelor of Science in Environmental and Sanitary Engineering (BS-ESE) is a 5 year Bachelors degree course offerred in the SEA department. After graduation Licensure Examination for Sanitary Engineers must be taken',
  tags: ['BSESE', 'BS', 'ESE', 'Bachelor', 'Science', 'Environmental', 'Sanitary', 'Engineering', 'Program', 'Course', 'SEA', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Industrial Technology, major in Mechatronics (BSIT-MECHA)',
  info: '4 year course, Bachelors Degree, offerred in SEA department',
  type: '',
  message: 'Bachelor of Science in Industrial Technology, major in Mechatronics (BSIT-MECHA) is a 4 Year Bachelors Degree course offerred in the SEA department',
  tags: ['BSIT-MECHA', 'BS', 'IT', 'Mecha', 'Bachelor', 'Science', 'Industrial', 'Technology', 'Mechatronics', 'Program', 'Course', 'SEA', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Computer Engineering (BS-CPE)',
  info: '4 year course, Bachelors Degree, offerred in SIT department',
  type: '',
  message: 'Bachelor of Science in Computer Engineering (BS-CPE) is a 4 year Bachelors Degree course offerred in the SIT department',
  tags: ['BSCPE', 'BS', 'CPE', 'Bachelor', 'Science', 'Computer', 'Engineering', 'Program', 'Course', 'SIT', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Computer Science (BS-CS)',
  info: '4 year course, Bachelors Degree, offerred in SIT department',
  type: '',
  message: 'Bachelor of Science in Computer Science (BS-CS) is a 4 year Bachelors Degree course offerred in the SIT department',
  tags: ['BSCS', 'BS', 'CS', 'ComSci', 'Bachelor', 'Science', 'Computer', 'Program', 'Course', 'SIT', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Information Technology (BS-IT)',
  info: '4 year course, Bachelors Degree, offerred in SIT department',
  type: '',
  message: 'Bachelor of Science in Information Technology (BS-IT) is a 4 year Bachelors Degree course offerred in the SIT department',
  tags: ['BSIT', 'BS', 'IT', 'Bachelor', 'Science', 'Information', 'Technology', 'Program', 'Course', 'SIT', 'Baccalaureate']
}, {
  name: 'Cisco Certified Entry Level (CCENT)',
  info: '108 hours, Short Course, offerred in SIT department',
  type: '',
  message: 'Cisco Certified Entry Level (CCENT) is a Short Course offerred in the SIT department',
  tags: ['CC', 'ENT', 'CCENT', 'Cisco', 'Certified', 'Entry', 'Level', 'Program', 'Short', 'Course', 'SIT']
}, {
  name: 'Cisco Certified Network Associate (CCNA)',
  info: '216 hours, Short Course, offerred in SIT department',
  type: '',
  message: 'Cisco Certified Network Associate (CCNA) is a Short Course offerred in the SIT department',
  tags: ['CC', 'NA', 'CCNA', 'Cisco', 'Certified', 'Network', 'Associate', 'Program', 'Course', 'SIT']
}, {
  name: 'Bachelor of Science in Hotel and Restaurant Management (BS-HRM)',
  info: '4 year course, Bachelors Degree, offerred in SIHTM department',
  type: '',
  message: 'Bachelor of Science in Hotel and Restaurant Management (BS-HRM) is a 4 year Bachelors Degree course offerred in the SIHTM department',
  tags: ['BSHRM', 'BS', 'HRM', 'Bachelor', 'Science', 'Hotel', 'Restaurant', 'Program', 'Course', 'SIHTM', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Tourism Management (BS-TM)',
  info: '4 year course, Bachelors Degree, offerred in SIHTM',
  type: '',
  message: 'Bachelor of Science in Tourism Management (BS-TM) is a 4 year Bachelors Degree course offerred in the SIHTM department',
  tags: ['BSTM', 'BS', 'TM', 'Bachelor', 'Science', 'Tourism', 'Management', 'Program', 'Course', 'SIHTM', 'Baccalaureate']
}, {
  name: 'Associate in Arts in Hotel and Restaurant Management (AA-HRM)',
  info: '2 year Ladderized Program, offerred in SIHTM',
  type: '',
  message: 'Associate in Arts in Hotel and Restaurant Management (AA-HRM) is a 2 year Ladderized Program offerred in SIHTM',
  tags: ['AAHRM', 'AA', 'HRM', 'Associate', 'Arts', 'Hotel', 'Restaurant', 'Management', 'Program', 'Course', 'SIHTM']
}, {
  name: 'Bachelor of Laws and Letters (LLB)',
  info: '4 year course, Bachelors Degree, must take BAR examination after graduation, offerred in SOL department',
  type: '',
  message: 'Bachelor of Laws and Letters (LLB) is a 4 year Bachelors Degree course offerred in the SOL department',
  tags: ['LLB', 'Bachelor', 'Laws', 'Letters', 'Program', 'Course', 'SOL', 'Baccalaureate']
}, {
  name: 'Master in Public Administration (MPA)',
  info: '2 year course, Masters Degree, must be a graduate of Bachelor of Arts in Broadcasting or Bachelor of Arts in Mass Communication in order to take, offerred in SLAHS department',
  type: '',
  message: 'Master in Public Administration (MPA) is a 2 year Masters Degree course for graduates of Bachelor of Arts in Broadcasting or Bachelor of Arts in Mass Communication offerred in the SLAHS department',
  tags: ['MA', 'PA', 'MPA', 'Master', 'Public', 'Administration', 'Program', 'Course', 'SLAHS']
}, {
  name: 'Master of Arts in English (MAEng)',
  info: '2 year course, Masters Degree, must be a Graduate of Bachelor of Arts in English in order to take, offerred in SLAHS department',
  type: '',
  message: 'Master of Arts in English (MAEng) is a 2 year Masters Degree course for Graduate of Bachelor of Arts in English offerred in SLAHS department',
  tags: ['MA', 'Eng', 'MAEng', 'Master', 'Arts', 'English', 'Program', 'Course', 'SLAHS']
}, {
  name: 'Bachelor of Arts in Broadcasting (BA-Broad)',
  info: '4 year course, Bachelors Degree, offerred in SLAHS',
  type: '',
  message: 'Bachelor of Arts in Broadcasting (BA-Broad) is a 4 year Bachelors Degree course offerred in the SLAHS department',
  tags: ['BABroad', 'BA', 'Broad', 'Bachelor', 'Arts', 'Broadcasting', 'Program', 'Course', 'SLAHS', 'Baccalaureate']
}, {
  name: 'Bachelor of Arts in English (BA-Eng)',
  info: '4 year course, Bachelors Degree, offerred in SLAHS',
  type: '',
  message: 'Bachelor of Arts in English (BA-Eng) is a 4 year Bachelors Degree course offerred in the SLAHS department',
  tags: ['BAEng', 'BA', 'Eng', 'Bachelor', 'Arts', 'English', 'Program', 'Course', 'SLAHS', 'Baccalaureate']
}, {
  name: 'Bachelor of Arts in Mass Communication (BA-Comm)',
  info: '4 year course, Bachelors Degree, offerred in SLAHS',
  type: '',
  message: 'Bachelor of Arts in Mass Communication (BA-Comm) is a 4 year Bachelors Degree course offerred in the SLAHS department',
  tags: ['BAComm', 'BA', 'Mass', 'Comm', 'Bachelor', 'Arts', 'Mass', 'Communication', 'Program', 'Course', 'SLAHS', 'Baccalaureate']
}, {
  name: 'Bachelor of Arts in Political Science(BA-PolSci)',
  info: '4 year course, Bachelors Degree, offerred in SLAHS',
  type: '',
  message: 'Bachelor of Arts in Political Science(BA-PolSci) is a 4 year Bachelors Degree course offerred in the SLAHS department',
  tags: ['BAPolSci', 'BA', 'PolSci', 'Bachelor', 'Arts', 'Political', 'Science', 'Program', 'Course', 'SLAHS', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Psychology (BS-Psych)',
  info: '4 year course, Bachelors Degree, offerred in SLAHS department',
  type: '',
  message: 'Bachelor of Science in Psychology (BS-Psych) is a 4 year Bachelors Degree Course offerred in the SLAHS department',
  tags: ['BSPsych', 'BS', 'Psych', 'Bachelor', 'Science', 'Psychology', 'Program', 'Course', 'SLAHS', 'Baccalaureate']
}, {
  name: 'Bachelor of Arts in Music (BA-Music)',
  info: '4 year course, Bachelors Degree, offerred in SLAHS',
  type: '',
  message: 'Bachelor of Arts in Music (BA-Music) is a 4 year Bachelors Degree course offerred in the SLAHS department',
  tags: ['BAMusic', 'BA', 'Bachelor', 'Arts', 'Music', 'Program', 'Course', 'SLAHS', 'Baccalaureate']
}, {
  name: 'Extension Classes in Music',
  info: '10 hours, Special Program, offerred in SLAHS',
  type: '',
  message: 'Extension Classes in Music is a 10 Hour Special Program offerred in the SLAHS department',
  tags: ['Extension', 'Classes', 'Music', 'SLAHS']
}, {
  name: 'Bachelor of Science in Physical Therapy (BS-PT)',
  info: '5 year course, Bachelors Degree, must take Licensure Examination for Physical Therapists after graduation, offerred in SNS department',
  type: '',
  message: 'Bachelor of Science in Physical Therapy (BS-PT) is a 5 year Bachelor Degree course offerred in the SNS department. After graduation Licensure Examination for Physical Therapists must be taken',
  tags: ['BSPT', 'BS', 'PT', 'Bachelor', 'Science', 'Physical', 'Therapy', 'SNS', 'Baccalaureate']
}, {
  name: 'Bachelor of Medical Laboratory Science (BMLS)',
  info: '4 year course, Bachelors Degree, must take Licensure Examination for Medical Technologists after graduation, offerred in SNS department',
  type: '',
  message: 'Bachelor of Medical Laboratory Science (BMLS) is a 4 year Bachelors Degree course offerred in the SNS department. After graduation Licensure Examination for Medical Technologists must be taken',
  tags: ['BMLS', 'BM', 'LS', 'Bachelor', 'Science', 'Medical', 'Laboratory', 'Program', 'Course', 'SNS', 'Baccalaureate']
}, {
  name: 'Bachelor of Science in Nursing (BSN)',
  info: '4 year course, Bachelors Degree, must take Licensure Examination for Nurses after graduation, offerred in SON department',
  type: '',
  message: 'Bachelor of Science in Nursing (BSN) is a 4 year Bachelors Degree course offerred in the SON department. After graduation Licensure Examination for Nurses after graduation must be taken',
  tags: ['BSN', 'BS', 'N', 'Bachelor', 'Science', 'Nursing', 'Program', 'Course', 'SON', 'Baccalaureate']
}, {
  name: 'Certificate in Health Care Services [Nursing Assistant]',
  info: '1 Year Short Course, offerred in SON',
  type: '',
  message: 'Certificate in Health Care Services [Nursing Assistant] is a 1 Year Short Course offerred in the SON department',
  tags: ['HCS', 'Health', 'Care', 'Services', 'Program', 'Course', 'SON']
}, {
  name: 'Doctor of Philosophy in Development Education (Ph.DevEd)',
  info: '3 year course, Doctorate Degree, must be a Graduate of Bachelor of Elementary Education or Bachelor of Secondary Education, offerred in STE department',
  type: '',
  message: 'Doctor of Philosophy in Development Education (Ph.DevEd) is a 3 year Doctorate Degree course for Graduates of Bachelor of Elementary Education or Bachelor of Secondary Education offerred in the STE department',
  tags: ['PHDevEd', 'PHD', 'evED', 'Doctor', 'Philosophy', 'Development', 'Education', 'Program', 'Course', 'STE']
}, {
  name: 'Doctor of Education',
  info: '3 year course, Doctorate Degree, must be a Graduate of Bachelor of Elementary Education or Bachelor of Secondary Education, offerred in STE department',
  type: '',
  message: 'Doctor of Education is a 3 year Doctorate Degree course for Graduate of Bachelor of Elementary Education or Bachelor of Secondary Education offerred in the STE department',
  tags: ['EDD', 'Doctor', 'Education', 'Program', 'Course', 'STE']
}, {
  name: 'Master of Arts in Education',
  info: '2 year course, Masters Degree, must be a Graduate of Bachelor of Elementary Education or Bachelor of Secondary Education, offerred in STE department',
  type: '',
  message: 'Master of Arts in Education is a 2 Year course for Graduate of Bachelor of Elementary Education or Bachelor of Secondary Education offerred in the STE department',
  tags: ['MAEd', 'MA', 'ED', 'Master', 'Arts', 'Education', 'Program', 'Course', 'STE']
}, {
  name: 'Bachelor of Elementary Education, major in General Education (BEEd-GenEd)',
  info: '4 year course, Bachelors Degree, offerred in STE department',
  type: '',
  message: '4 Years',
  tags: ['BEEdGenEd', 'BE', 'Ed', 'Gen', 'GenEd', 'Bachelor', 'Elementary', 'Education', 'Major', 'General', 'Education', 'Program', 'Course', 'STE', 'Baccalaureate']
}, {
  name: 'Bachelor of Elementary Education, major in Special Education (BEEd-SpEd)',
  info: '4 year course, Bachelors Degree, offerred in STE department',
  type: '',
  message: 'Bachelor of Elementary Education, major in Special Education (BEEd-SpEd) is a 4 year Bachelors Degree course offerred in the STE department',
  tags: ['BEEdSpEd', 'BE', 'Sp', 'Ed', 'SpEd', 'Bachelor', 'Elementary', 'Special', 'Education', 'Program', 'Course', 'STE', 'Baccalaureate']
}, {
  name: 'Bachelor of Secondary Education (BSED)',
  info: '4 year course, Bachelors Degree, must take Licensure Examination for Teachers, offerred in STE',
  type: '',
